    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-xs text-gray-500">
          <span className="bg-oye-card px-3">o continúa con</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className="flex items-center justify-center gap-2 py-2.5 border border-white/20 rounded-lg text-white text-sm hover:bg-white/5 transition-colors"
        >
      ...
      <p className="text-center text-gray-400 text-sm">
        ¿No tienes cuenta?{" "}
        <Link href="/register" className="text-oye-red hover:underline">
          Regístrate gratis
        </Link>
      </p>
    </form>
